...
#  Created by Encounter(R) RTL Compiler RC12.22 - v12.20-s014_1 on Thu Aug 21 17:04:50 +0200 2014
...
create_generated_clock -name "clk_8n" -divide_by 2     -source [get_ports clkIn_4n]   [get_pins {SerializerTop_I/SerializerMain_I/Cnt4_reg[0]/Q}] 
create_generated_clock -name "clk_16n" -divide_by 4     -source [get_ports clkIn_4n]   [get_pins {SerializerTop_I/SerializerMain_I/Cnt4_reg[1]/Q}] 
create_generated_clock -name "clk_3n2" -divide_by 4     -source [get_ports clk_800p]   [get_pins {SerializerTop_I/ClockGen_I/FastCnt4_reg[1]/Q}] 
create_generated_clock -name "clk_1n6" -divide_by 2     -source [get_ports clk_800p]   [get_pins SerializerTop_I/ClockGen_I/clkOut_1n6_reg/Q] 
...
set_false_path -from [list \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[0]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[10]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[11]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[12]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[13]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[14]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[15]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[16]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[17]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[18]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[19]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[1]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[20]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[21]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[22]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[23]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[24]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[25]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[26]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[27]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[28]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[29]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[2]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[30]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[31]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[32]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[33]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[34]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[35]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[36]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[37]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[38]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[39]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[3]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[4]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[5]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[6]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[7]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[8]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/TenToEight_reg[9]}] ] -to [list \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1L_reg[0]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1L_reg[1]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1L_reg[2]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1L_reg[3]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1L_reg[4]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1L_reg[5]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1L_reg[6]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1L_reg[7]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1R_reg[0]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1R_reg[1]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1R_reg[2]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1R_reg[3]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1R_reg[4]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1R_reg[5]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1R_reg[6]}]  \
  [get_cells {SerializerTop_I/SerializerMain_I/Tree1R_reg[7]}] ]
