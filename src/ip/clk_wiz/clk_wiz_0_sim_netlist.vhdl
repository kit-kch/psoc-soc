...
entity clk_wiz_0_clk_wiz_0_clk_wiz is
  port (
    clk_soc : out STD_LOGIC;
    clk_adau_mclk : out STD_LOGIC;
    reset : in STD_LOGIC;
...
architecture STRUCTURE of clk_wiz_0_clk_wiz_0_clk_wiz is
  signal clk_adau_mclk_clk_wiz_0 : STD_LOGIC;
  signal clk_in1_clk_wiz_0 : STD_LOGIC;
  signal clk_soc_clk_wiz_0 : STD_LOGIC;
...
clkout2_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_adau_mclk_clk_wiz_0,
      O => clk_adau_mclk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 57.750000,
      ...
      CLKOUT0 => clk_soc_clk_wiz_0,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_adau_mclk_clk_wiz_0,
